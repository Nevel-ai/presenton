...
def get_user_config():
    ...
    return UserConfig(
        ...
        OPENAI_PROXY_URL=existing_config.OPENAI_PROXY_URL or get_openai_proxy_url_env(),
...
def update_env_with_user_config():
    ...
    if user_config.OPENAI_PROXY_URL:
        set_openai_proxy_url_env(user_config.OPENAI_PROXY_URL)
