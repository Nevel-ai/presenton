...
const setupUserConfigFromEnv = () => {
  ...
  const userConfig = {
    ...
    OBJECT_STORAGE_ENDPOINT: process.env.OBJECT_STORAGE_ENDPOINT || existingConfig.OBJECT_STORAGE_ENDPOINT,
    OBJECT_STORAGE_ACCESS_KEY_ID: process.env.OBJECT_STORAGE_ACCESS_KEY_ID || existingConfig.OBJECT_STORAGE_ACCESS_KEY_ID,
    OBJECT_STORAGE_SECRET_ACCESS_KEY: process.env.OBJECT_STORAGE_SECRET_ACCESS_KEY || existingConfig.OBJECT_STORAGE_SECRET_ACCESS_KEY,
    OBJECT_STORAGE_REGION: process.env.OBJECT_STORAGE_REGION || existingConfig.OBJECT_STORAGE_REGION,
    OBJECT_STORAGE_BUCKET_NAME: process.env.OBJECT_STORAGE_BUCKET_NAME || existingConfig.OBJECT_STORAGE_BUCKET_NAME,
  };
